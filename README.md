...
- **Teddy-Editor** > A modeless text editor I wrote in C that I may add new features as I start using it more and more. It was named "Teddy" because the first 3 letters stand for "**T**ext **Ed**itor".
...
- **Package-Manager** (unnamed for now) > A package manager for the Omicron ecosystem with its own repositories.