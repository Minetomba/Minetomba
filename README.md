...
- **Package-Manager** (unnamed for now) - A package manager for Omicron with its own repositories. Development stage: **ARCHIVE DEPACKAGER** > INSTALLER > SYSTEMD INTEGRATION > OMICRON INTEGRATION > FINISHED
- **CIM-Lang** - A minimal systems programming language made for RV32GC. Named CIM because it stands for **C**-**Im**proved. In development: SYNTAX DEFINITION > TOKENIZER > **PARSER** > ASSEMBLER
